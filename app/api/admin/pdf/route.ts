...
function generatePdfHtml(name: string, ticket: string, isEN: boolean) {
  const t = isEN ? {
    ...
    s09: 'Who built this',
    bio: '<strong>Constitutional lawyer</strong> · STF researcher (25+ years) · Founder, Instituto Constituição Aberta (ICONS) · Visiting Scholar, Università degli Studi di Milano-Bicocca',
    s10: 'Access',
    ...
    s09: 'Quem construiu',
    bio: '<strong>Advogada constitucionalista</strong> · Pesquisadora STF (25+ anos) · Fundadora, Instituto Constituição Aberta (ICONS) · Visiting Scholar, Università degli Studi di Milano-Bicocca',
    s10: 'Acesso',
