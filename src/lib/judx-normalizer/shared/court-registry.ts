...
export const COURT_REGISTRY: Record<CourtId, CourtDefinition> = {
  ...
  stf: {
    ...
    judxPrefix: 'STF',
    status: 'active',
    allowedSources: ['stf_decisoes'],
    pipelineModes: ['core'],
    canCompareWith: [],
    dataContracts: {
      stf_decisoes: {
        inspectedAt: '2026-03-27',
        fieldsValidated: [
          'processo', 'orgao_julgador', 'relator_decisao', 'relator_atual',
          'data_autuacao', 'data_decisao', 'data_baixa', 'grupo_origem',
          'tipo_classe', 'classe', 'ramo_direito', 'assunto', 'assunto_completo',
          'incidente', 'link_processo', 'cod_andamento', 'subgrupo_andamento',
          'descricao_andamento', 'observacao_andamento', 'tipo_decisao',
          'ambiente_julgamento', 'indicador_colegiado', 'id_fato_decisao',
        ],
        estimatedSizePerRow: '1.1 KB',
        loadStrategy: 'full',
        notes: '169K rows (145K do 372e + 24K do e7a4). ambiente_julgamento preenchido apenas no e7a4. Dedup por md5(observacao_andamento).',
      },
    },
  },
};
